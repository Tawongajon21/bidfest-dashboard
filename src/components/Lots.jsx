...
<div style={{
    ...
    alignContent:"center"
      ...
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Auctions /</span> Auction Lots</h4>
<button type="button" style={{
  height:"3rem"
}} class="btn btn-outline-primary">Add Lot</button>
</div>
